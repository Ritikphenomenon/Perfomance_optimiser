    ...
    return (
      <section>
        ...
        <section id="actions-container">
          <button data-type="play" style={{width:"auto",height:"auto"}} onClick = {this.playStopTimer}>Play</button>
          <button data-type="stop" style={{width:"auto",height:"auto"}} onClick = {this.playStopTimer}>Stop</button>
          <button onClick = {this.resetTimer} style={{width:"auto",height:"auto"}} >Refresh</button>
        </section>
      </section>
    )
  }
